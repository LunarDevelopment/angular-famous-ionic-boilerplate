...
var getRepository = function() {
    var repository = 'https://github.com/LunarDevelopment/angular-famous-ionic-boilerplate.git';
    try {
...
module.exports = function() {
    ...
    var constants = {
        ...
        fonts: {
            src: ['./' + clientFolder + '/fonts/*.*', './' + clientFolder + '/fonts/{{targetName}}/**/*.*', './bower_components/ionic/release/fonts/*.*', './bower_components/font-awesome/fonts/*.*'], // you can also add a specific src_appname
            dest: 'fonts'
        },
        html: {
        ...
        serve: {
            ...
            localtunnel: false, // true, false or 'afi'
            ghostMode: {
                clicks: false,
                forms: false,
                scroll: false
